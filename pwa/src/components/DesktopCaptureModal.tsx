...
export function DesktopCaptureModal({ initialUrl = '', onClose }: DesktopCaptureModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-hairline-faint px-5 py-4">
          ...
          <button onClick={onClose} className="ml-auto rounded-[6px] p-1.5 text-ink-3 hover:bg-hairline-faint">
            <X className="h-4 w-4" />
          </button>
        </div>
